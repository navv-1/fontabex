<script lang="ts">
  ...
  function openRepo() {
    openUrl("https://github.com/navv-1/fontabex").catch(console.error);
  }
</script>
...
<div class="welcome-shell">
  ...
  <header class="welcome-header" oncontextmenu={showTitlebarContextMenu}>
    ...
    <div class="header-actions">
      <button
        class="button button-outline button-icon header-btn"
...
<style>
  ...
  .app-version {
    ...
    border-radius: 12px;
    margin-top: 0.25rem;
    animation: titleEntrance 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.25s both;
  }
