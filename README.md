...
- Page through very large table byte ranges in the hex pane.
...
Table Directory, `avar`, `CFF `, `CFF2`, `cmap`, `cvar`, `fvar`, `glyf`, `gvar`, `head`, `hhea`, `hmtx`, `HVAR`, `loca`, `maxp`, `MVAR`, `name`, `OS/2`, `post`, `STAT`, `vhea`, `vmtx`, `VORG`, `VVAR`.
